...
<form id="adminForm" name="adminForm" class="adminForm" method="POST">
	...
	<input type="hidden" name="return_url" value="<?php echo JRoute::_('index.php?option=com_customfields&controller=' . $this->_view_name . '&task=index&context='.$context.'&extension='.$extension) ?>">
